...
scandium: $(INTERNAL_OTA_PACKAGE_TARGET)
	...
	@echo -e ${CL_GRN}"   ______                                       __  __                           ______    ______   "${CL_GRN}
	@echo -e ${CL_GRN}"  /      \                                     /  |/  |                         /      \  /      \  "${CL_GRN}
	@echo -e ${CL_GRN}" /$$$$$$  |  _______   ______   _______    ____$$ |$$/  __    __  _____  ____  /$$$$$$  |/$$$$$$  | "${CL_GRN}
	@echo -e ${CL_GRN}" $$ \__$$/  /       | /      \ /       \  /    $$ |/  |/  |  /  |/     \/    \ $$ |  $$ |$$ \__$$/  "${CL_GRN}
	@echo -e ${CL_GRN}" $$      \ /$$$$$$$/  $$$$$$  |$$$$$$$  |/$$$$$$$ |$$ |$$ |  $$ |$$$$$$ $$$$  |$$ |  $$ |$$      \  "${CL_GRN}
	@echo -e ${CL_GRN}"  $$$$$$  |$$ |       /    $$ |$$ |  $$ |$$ |  $$ |$$ |$$ |  $$ |$$ | $$ | $$ |$$ |  $$ | $$$$$$  | "${CL_GRN}
	@echo -e ${CL_GRN}" /  \__$$ |$$ \_____ /$$$$$$$ |$$ |  $$ |$$ \__$$ |$$ |$$ \__$$ |$$ | $$ | $$ |$$ \__$$ |/  \__$$ | "${CL_GRN}
	@echo -e ${CL_GRN}" $$    $$/ $$       |$$    $$ |$$ |  $$ |$$    $$ |$$ |$$    $$/ $$ | $$ | $$ |$$    $$/ $$    $$/  "${CL_GRN}
	@echo -e ${CL_GRN}"  $$$$$$/   $$$$$$$/  $$$$$$$/ $$/   $$/  $$$$$$$/ $$/  $$$$$$/  $$/  $$/  $$/  $$$$$$/   $$$$$$/   "${CL_GRN}
